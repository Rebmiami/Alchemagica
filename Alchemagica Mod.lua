...
local catl = elements.allocate("alchmag", "CATL") -- Catalyst
local cond = elements.allocate("alchmag", "COND") -- Conduit
local mana = elements.allocate("alchmag", "MANA") -- Mana
local brew = elements.allocate("alchmag", "BREW") -- Brew
